...
export interface MadStartProps {
  title: string
  subtitle: string
  features: string[]
  buttonText: string
...
const MadStart: React.FC<MadStartProps> = ({
  title,
  subtitle,
  features,
  buttonText,
  ...
  return (
    <section className="demo-video-gate-panel demo-video-gate-panel--start">
      <div className="demo-video-gate-panel__icon demo-video-gate-panel__icon--teal">
        <svg
          width="36"
          height="36"
          fill="var(--primary)"
      ...
      <button
        type="button"
        className="btn demo-video-gate-panel__cta demo-video-gate-panel__cta--teal"
        onClick={handleStart}
      >
        {buttonText}
